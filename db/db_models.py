...
from sqlalchemy import Table, DateTime, Column, String, Integer, Enum, ForeignKey, func, UniqueConstraint
...
class Right(Base):
    ...
    __tablename__ = 'right'
    __table_args__ = (UniqueConstraint('object', 'access', 'scope', name='_customer_location_uc'),)
